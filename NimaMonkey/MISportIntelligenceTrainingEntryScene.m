//
//  MISportIntelligenceTrainingEntryScene.m
//  NimaMonkey
//
...
@implementation MISportIntelligenceTrainingEntryScene
...
+(id)scene{
    ...
    MISportIntelligenceTrainingEntryScene *layer = [MISportIntelligenceTrainingEntryScene node];
...
-(void)addSceneTitle{
    ...
    CCLabelTTF *currentSceneTitle = [CCLabelTTF labelWithString:@"MI训练内容-运动智能" fontName:@"ChalkboardSE-Bold" fontSize:40];
