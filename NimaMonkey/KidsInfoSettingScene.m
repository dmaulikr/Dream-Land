...
@implementation KidsInfoSettingScene
...
+(id)scene{
    ...
    KidsInfoSettingScene *layer = [KidsInfoSettingScene node];
...
-(void)addSceneTitle{
    ...
    CCLabelTTF *currentSceneTitle = [CCLabelTTF labelWithString:@"宝宝信息设置界面" fontName:@"ChalkboardSE-Bold" fontSize:40];
...
-(void)avatarSetting{
    ...
    CCSprite *avatar = [CCSprite spriteWithFile:@"babysquare-ipad.png"];
...
-(void)addGenderLabel{
    ...
    CCLabelTTF *genderLabel = [CCLabelTTF labelWithString:@"选择宝宝的性别" fontName:@"ChalkboardSE-Bold" fontSize:30];
    genderLabel.color = ccc3(16,174,231);
    
    genderLabel.position = ccp(size.width*0.3,size.height*0.55);
...
-(void)addBornDateSettingLabel{
    
    CGSize size = [CCDirector sharedDirector].winSize;
    
    CCLabelTTF *bornDateLabel = [CCLabelTTF labelWithString:@"选择宝宝的出生日期" fontName:@"ChalkboardSE-Bold" fontSize:30];
    bornDateLabel.color = ccc3(16,174,231);
    
    bornDateLabel.position = ccp(size.width*0.3,size.height*0.45);
    [self addChild:bornDateLabel z:1];
    
    
}

-(void)addBornDateSetting{
    
    [self addBornDateSettingLabel];
