...
@implementation GameIntroScene4
...
+(id)scene{
    ...
    GameIntroScene4 *layer = [GameIntroScene4 node];
...
-(void)enterNewScene{
    ...
    [SceneManager goChooseLoginTypeScene];
}
...
-(void)addSceneTitle{
    ...
    CCLabelTTF *currentSceneTitle = [CCLabelTTF labelWithString:@"引导界面4" fontName:@"ChalkboardSE-Bold" fontSize:40];
