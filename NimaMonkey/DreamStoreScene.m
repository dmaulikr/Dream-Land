...
@implementation DreamStoreScene
...
+(id)scene{
    ...
    DreamStoreScene *layer = [DreamStoreScene node];
...
-(void)addSceneTitle{
    ...
    CCLabelTTF *currentSceneTitle = [CCLabelTTF labelWithString:@"游戏梦幻商城界面" fontName:@"ChalkboardSE-Bold" fontSize:40];
