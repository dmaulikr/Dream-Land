...
@implementation AntiGameAddictionScene
...
+(id)scene{
    ...
    AntiGameAddictionScene *layer = [AntiGameAddictionScene node];
...
-(void)addSceneTitle{
    ...
    CCLabelTTF *currentSceneTitle = [CCLabelTTF labelWithString:@"防沉迷设置界面" fontName:@"ChalkboardSE-Bold" fontSize:40];
