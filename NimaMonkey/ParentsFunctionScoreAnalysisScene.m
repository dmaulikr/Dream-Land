//
//  ParentFunctionScoreAnalysisScene.m
//  NimaMonkey
//
...
@implementation ParentsFunctionScoreAnalysisScene
...
+(id)scene{
    ...
    ParentsFunctionScoreAnalysisScene *layer = [ParentsFunctionScoreAnalysisScene node];
...
-(void)addSceneTitle{
    ...
    CCLabelTTF *currentSceneTitle = [CCLabelTTF labelWithString:@"父母界面-成绩分析" fontName:@"ChalkboardSE-Bold" fontSize:40];
