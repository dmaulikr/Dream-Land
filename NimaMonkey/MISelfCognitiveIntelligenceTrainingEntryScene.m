//
//  MISelfCognitiveIntelligenceTrainingEntryScene.m
//  NimaMonkey
//
...
@implementation MISelfCognitiveIntelligenceTrainingEntryScene
...
+(id)scene{
    ...
    MISelfCognitiveIntelligenceTrainingEntryScene *layer = [MISelfCognitiveIntelligenceTrainingEntryScene node];
...
-(void)addSceneTitle{
    ...
    CCLabelTTF *currentSceneTitle = [CCLabelTTF labelWithString:@"MI训练内容-自我认知智能" fontName:@"ChalkboardSE-Bold" fontSize:40];
