//
//  MINaturalObservationIntelligenceTrainingEntryScene.m
//  NimaMonkey
//
...
@implementation MINaturalObservationIntelligenceTrainingEntryScene
...
+(id)scene{
    ...
    MINaturalObservationIntelligenceTrainingEntryScene *layer = [MINaturalObservationIntelligenceTrainingEntryScene node];
...
-(void)addSceneTitle{
    ...
    CCLabelTTF *currentSceneTitle = [CCLabelTTF labelWithString:@"MI训练内容-自然观察智能" fontName:@"ChalkboardSE-Bold" fontSize:40];
