...
@implementation ParentsFunctionSocialScene
...
+(id)scene{
    ...
    ParentsFunctionSocialScene *layer = [ParentsFunctionSocialScene node];
...
-(void)addSceneTitle{
    ...
    CCLabelTTF *currentSceneTitle = [CCLabelTTF labelWithString:@"父母界面-LBS社交" fontName:@"ChalkboardSE-Bold" fontSize:40];
