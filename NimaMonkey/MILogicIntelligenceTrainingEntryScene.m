//
//  MILogicIntelligenceTrainingEntryScene.m
//  NimaMonkey
//
...
@implementation MILogicIntelligenceTrainingEntryScene
...
+(id)scene{
    ...
    MILogicIntelligenceTrainingEntryScene *layer = [MILogicIntelligenceTrainingEntryScene node];
...
-(void)addSceneTitle{
    ...
    CCLabelTTF *currentSceneTitle = [CCLabelTTF labelWithString:@"MI训练内容-数理逻辑智能" fontName:@"ChalkboardSE-Bold" fontSize:40];
