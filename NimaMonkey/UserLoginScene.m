...
+(id)scene{
    ...
    UserLoginScene *layer = [UserLoginScene node];
...
-(void)addSceneTitle{
    ...
    CCLabelTTF *currentSceneTitle = [CCLabelTTF labelWithString:@"用户登陆界面" fontName:@"ChalkboardSE-Bold" fontSize:40];
