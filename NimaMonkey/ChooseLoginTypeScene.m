...
@implementation ChooseLoginTypeScene{
...
+(id)scene{
    ...
    ChooseLoginTypeScene *layer = [ChooseLoginTypeScene node];
...
-(void)addEntryMenu{
    ...
    registerItem.position =ccp(screenSize.width*0.65,screenSize.height*0.45);
...
//    [SceneManager goFirstTimeSettingGuidelineScene];
    ...
    [SceneManager goUserSignupScene];
}
...
-(void)addSceneTitle{
    ...
    CCLabelTTF *currentSceneTitle = [CCLabelTTF labelWithString:@"选择登陆类型（账号，微博，QQ）" fontName:@"ChalkboardSE-Bold" fontSize:40];
