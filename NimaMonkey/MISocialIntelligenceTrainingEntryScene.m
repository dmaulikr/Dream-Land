//
//  MISocialIntelligenceTrainingScene.m
//  NimaMonkey
//
...
@implementation MISocialIntelligenceTrainingEntryScene
...
+(id)scene{
    ...
    MISocialIntelligenceTrainingEntryScene *layer = [MISocialIntelligenceTrainingEntryScene node];
...
-(void)addSceneTitle{
    ...
    CCLabelTTF *currentSceneTitle = [CCLabelTTF labelWithString:@"MI训练内容-人际智能" fontName:@"ChalkboardSE-Bold" fontSize:40];
