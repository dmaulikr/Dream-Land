//
//  MIMusicIntelligenceTrainingScene.m
//  NimaMonkey
//
...
@implementation MIMusicIntelligenceTrainingEntryScene
...
+(id)scene{
    ...
    MIMusicIntelligenceTrainingEntryScene *layer = [MIMusicIntelligenceTrainingEntryScene node];
...
-(void)addSceneTitle{
    ...
    CCLabelTTF *currentSceneTitle = [CCLabelTTF labelWithString:@"MI训练内容-音乐智能" fontName:@"ChalkboardSE-Bold" fontSize:40];
