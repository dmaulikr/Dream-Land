...
@implementation KidsSocialScene
...
+(id)scene{
    ...
    KidsSocialScene *layer = [KidsSocialScene node];
...
-(void)addSceneTitle{
    ...
    CCLabelTTF *currentSceneTitle = [CCLabelTTF labelWithString:@"宝宝好友系统界面" fontName:@"ChalkboardSE-Bold" fontSize:40];
