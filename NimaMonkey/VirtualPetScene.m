...
@implementation VirtualPetScene
...
+(id)scene{
    ...
    VirtualPetScene *layer = [VirtualPetScene node];
...
-(void)addSceneTitle{
    ...
    CCLabelTTF *currentSceneTitle = [CCLabelTTF labelWithString:@"虚拟宠物界面" fontName:@"ChalkboardSE-Bold" fontSize:40];
