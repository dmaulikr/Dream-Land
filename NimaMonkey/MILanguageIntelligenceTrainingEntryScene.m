//
//  MILanguageIntelligenceTrainingScene.m
//  NimaMonkey
//
...
@implementation MILanguageIntelligenceTrainingEntryScene
...
+(id)scene{
    ...
    MILanguageIntelligenceTrainingEntryScene *layer = [MILanguageIntelligenceTrainingEntryScene node];
...
-(void)addSceneTitle{
    ...
    CCLabelTTF *currentSceneTitle = [CCLabelTTF labelWithString:@"MI训练内容-语言智能" fontName:@"ChalkboardSE-Bold" fontSize:40];
