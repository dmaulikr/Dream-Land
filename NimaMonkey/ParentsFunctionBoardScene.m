...
@implementation ParentsFunctionBoardScene
...
+(id)scene{
    ...
    ParentsFunctionBoardScene *layer = [ParentsFunctionBoardScene node];
...
-(void)addSceneTitle{
    ...
    CCLabelTTF *currentSceneTitle = [CCLabelTTF labelWithString:@"父母界面-查看排行榜" fontName:@"ChalkboardSE-Bold" fontSize:40];
