...
@implementation GameIntroScene3
...
+(id)scene{
    ...
    GameIntroScene3 *layer = [GameIntroScene3 node];
...
-(void)enterNewScene{
    ...
    [SceneManager goGameIntroScene4];
}
...
-(void)addSceneTitle{
    ...
    CCLabelTTF *currentSceneTitle = [CCLabelTTF labelWithString:@"引导界面3" fontName:@"ChalkboardSE-Bold" fontSize:40];
