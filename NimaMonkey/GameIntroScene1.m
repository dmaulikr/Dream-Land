...
@implementation GameIntroScene1
#pragma mark 类方法

+(id)scene{
    
    CCScene *scene =[CCScene node];
    GameIntroScene1 *layer = [GameIntroScene1 node];
...
-(void)addSceneTitle{
    ...
    CCLabelTTF *currentSceneTitle = [CCLabelTTF labelWithString:@"引导界面1" fontName:@"ChalkboardSE-Bold" fontSize:40];
